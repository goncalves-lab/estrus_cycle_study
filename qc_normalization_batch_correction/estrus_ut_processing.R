...
t_combined <- merge(`0002_mouse1_ut_filtered`, y = c(`0002_mouse10_ut_filtered`,`0002_mouse11_ut_filtered`,`0002_mouse12_ut_filtered`,
                                                     `0002_mouse13_ut_filtered`,`0002_mouse14_ut_filtered`,`0002_mouse15_ut_filtered`,
                                                     `0002_mouse16_ut_filtered`,`0002_mouse2_ut_filtered`,`0002_mouse3_ut_filtered`,
                                                     `0002_mouse6_ut_filtered`,`0002_mouse8_ut_filtered`,
                                                     `0002_mouse9_ut_filtered`), project = "mouse_ut", merge.data=TRUE)
...
t_combined_cell_metadata <- t_combined_cell_metadata %>% mutate(condition = case_when(
  batch == "0002_mouse1_ut" | batch == "0002_mouse6_ut" | batch == "0002_mouse12_ut" | batch == "0002_mouse13_ut" ~ "proestrus",
  batch == "0002_mouse2_ut" | batch == "0002_mouse8_ut" | batch == "0002_mouse16_ut"  ~ "diestrus", 
  batch == "0002_mouse3_ut" | batch == "0002_mouse9_ut" | batch == "0002_mouse14_ut" ~ "estrus",
  batch == "0002_mouse10_ut" | batch == "0002_mouse11_ut" | batch == "0002_mouse15_ut" ~ "metestrus"))
...
write.table(t_combined_clusters,"ut_combined_clusters",sep=",",quote=F,row.names = F)
write.table(t_subset_clusters,"ut_combined_clusters_subset",sep=",",quote=F,row.names = F)

new_cluster_id_t_com=c("SC", "SC", "?", "EpC", "SC", "NKC","?","?", "APC", "EpC", "?", "?","?", "APC","SC", "TC", "EpC", "SC","SC", "APC", "SC","APC",
                       "?" ,"EpC", "EC", "EpC", "SC","EpC", "MaC")
...
t <- t %>% mutate(cell_names = case_when(
  type == 8 | type == 13 | type == 19 | type == 21  ~ "APC",
  type == 0 | type == 1 | type == 4 | type == 14 | type == 17 | type == 18 | type == 20 | type == 26 ~ "SC",
  type == 3 | type == 16 | type ==  23 | type == 25 | type == 27  ~ "EpC",
  type == 2 | type == 6 | type == 7 | type == 10 | type == 11 | type == 12 | type == 22 | type == 28 | type == 9 ~ "?",
  type == 15  ~ "TC",
  type == 24 ~ "EC",
  type == 5 ~ "NKC",
  type == 28 ~ "MaC"
...
t_combined_cell_metadata$tissue <- "uterus"


t_combined_cds <- garnett_annotatoR_part1(t_combined, t_combined_cell_metadata, "uterus_markers_garnett")
t_combined <- garnett_annotatoR_part2(t_combined_cds, t_combined_cds, "uterus_markers_garnett", t_combined)
...
garnett_annotation_ex <- garnett_annotation_ex %>% mutate(cell_labels_garnett_ex = case_when(
  seurat_clusters == 8 | seurat_clusters == 13 | seurat_clusters == 19 | seurat_clusters == 21  ~ "APC",
  seurat_clusters == 0 | seurat_clusters == 1 | seurat_clusters == 4  | seurat_clusters == 7| seurat_clusters == 10 | seurat_clusters == 17 
  | seurat_clusters == 18 ~ "SC",
  seurat_clusters == 6  | seurat_clusters == 9 | seurat_clusters == 2 | seurat_clusters == 3 | seurat_clusters == 16 | seurat_clusters ==  23 
  | seurat_clusters == 25 | seurat_clusters == 27 | seurat_clusters == 22  ~ "EpC",
  seurat_clusters == 15  ~ "TC",
  seurat_clusters == 24 ~ "EC",
  seurat_clusters == 5 | seurat_clusters == 20 | seurat_clusters == 26 | seurat_clusters == 11 
  | seurat_clusters == 12  | seurat_clusters == 28 | seurat_clusters == 14 | seurat_clusters == 20 | seurat_clusters == 26 ~ "NKC",
  seurat_clusters == 28 ~ "MaC"
))
...
save(t_combined,file="ut_combined_new.Rdata")

list[t_non_match_ge, t_match_ge] <- svm_subseteR(t_combined)

pred.te_identity <- svm_returneR(t_match_ge, t_non_match_ge, 0.7, 0.5)
...
svm_annotation_ex <- svm_annotation_ex %>% mutate(cell_labels_smv_ex = case_when(
  seurat_clusters == 2  | seurat_clusters == 6 | seurat_clusters == 7 | 
    seurat_clusters == 9 | seurat_clusters == 10 | seurat_clusters == 11 |
    seurat_clusters == 12 | seurat_clusters == 14 | seurat_clusters == 20~ "SC",
  seurat_clusters == 22| seurat_clusters == 26 ~ "SC",
  seurat_clusters == 28 ~"MaC"
))
...
new_cluster_id_epc=c("GlC", "GlC", "GlC", "?", "?", "?","?", "CEpC", "CEpC","GlC", "CC", "CEpC" ,"CC", "?")
epc <- subseteR_part_2(t_epc, new_cluster_id_epc)

epc <- epc %>% mutate(cell_names = case_when(
  type == 0 | type == 1  | type == 2  | type == 9 ~ "GlC",
  type == 10  | type == 12  ~ "CC",
  type == 7  | type == 8 | type == 11 | type == 5 ~ "CEpC",
  type == 3 | type == 4  | type == 6 | type ==  13 ~ "?"
...
t_epc_cell_metadata$tissue <- "uterus"
t_combined_cds_ep <- garnett_annotatoR_part1(t_epc, t_epc_cell_metadata, "ut_markers_ep")
t_epc <- garnett_annotatoR_part2(t_combined_cds_ep,t_combined_cds_ep, "ut_markers_ep", t_epc)
...
garnett_annotation_ex_epc <- garnett_annotation_ex_epc %>% mutate(cell_labels_garnett_ex = case_when(
  seurat_clusters == 0 | seurat_clusters == 2 | seurat_clusters == 3 | seurat_clusters == 7 | 
    seurat_clusters == 9 | seurat_clusters == 13 ~ "GlC",
  seurat_clusters ==  4 | seurat_clusters == 6 | seurat_clusters ==  10 | seurat_clusters == 12 ~ "CC",
  seurat_clusters == 5 | seurat_clusters == 8 | seurat_clusters ==  11  ~ "CEpC",
  seurat_clusters == 1  ~ "Unknown"
))
...
svm_annotation_ex_epc <- svm_annotation_ex_epc %>% mutate(cell_labels_smv_ex = case_when(
  seurat_clusters == 5  | seurat_clusters == 1| seurat_clusters == 3 | seurat_clusters == 4    ~ "GlC",
  seurat_clusters == 13 | seurat_clusters == 7  ~ "CEpC",
  seurat_clusters == 6 ~ "EpC I"
))
...
save(t_epc,file="ut_epc_final.Rdata")
...
new_cluster_id_sc=c( "F", "F", "F" ,"F", "F", "F", "F" ,"F", "F",  "F", "F", "F", "F", "F", "F" ,"F", "F","F", "MC", "?","MC", "F", "F")
...
sc <- sc %>% mutate(cell_names = case_when(
  ...
  | type == 11  | type == 12  | type == 13  | type == 14  | type == 15  | type == 16  | type == 17  | type == 21  | type == 22  ~ "F",
  type == 18   | type == 20 ~ "MC",
  type == 19 ~ "?" 
...
t_sc_cell_metadata$tissue <- "uterus"
t_combined_cds_ep <- garnett_annotatoR_part1(t_sc, t_sc_cell_metadata, "ut_markers_sc")
t_sc <- garnett_annotatoR_part2(t_combined_cds_ep,t_combined_cds_ep, "ut_markers_sc", t_sc)
...
garnett_annotation_ex_sc <- garnett_annotation_ex_sc %>% mutate(cell_labels_garnett_ex = case_when(
  seurat_clusters == 1 | seurat_clusters == 3  | seurat_clusters == 14 | seurat_clusters == 13  | seurat_clusters == 15
  | seurat_clusters == 17 | seurat_clusters == 21  ~ "F",
  seurat_clusters == 18 | seurat_clusters == 19 | seurat_clusters == 20 ~ "MC",
  seurat_clusters == 0 | seurat_clusters == 2 | seurat_clusters == 4 | seurat_clusters == 5 | seurat_clusters == 6 | 
    seurat_clusters == 7 | seurat_clusters == 8 | seurat_clusters == 9 | seurat_clusters == 10
  | seurat_clusters == 12 | seurat_clusters == 16 | seurat_clusters == 22 | seurat_clusters == 11  ~ "Unknown"
))
...
svm_annotation_ex_sc <- svm_annotation_ex_sc %>% mutate(cell_labels_smv_ex = case_when(
  seurat_clusters == 0 | seurat_clusters == 2 | seurat_clusters == 4 | seurat_clusters == 5 | seurat_clusters == 6 | 
    seurat_clusters == 7 | seurat_clusters == 8 | seurat_clusters == 9 | seurat_clusters == 10 ~ "F",
  seurat_clusters == 11 |  seurat_clusters == 12  | seurat_clusters == 16 |  seurat_clusters == 22 ~ "F",
  seurat_clusters == 19 ~ "SC I"
))
...
save(t_sc,file="ut_sc_final.Rdata")
...
t_tc_cell_metadata$tissue <- "uterus"
t_combined_cds_ep <- garnett_annotatoR_part1(t_tc, t_tc_cell_metadata, "ut_markers_tc")
t_tc <- garnett_annotatoR_part2(t_combined_cds_ep,t_combined_cds_ep, "ut_markers_tc", t_tc)
...
garnett_annotation_ex_tc <- garnett_annotation_ex_tc %>% mutate(cell_labels_garnett_ex = case_when(
  seurat_clusters ==  0 | seurat_clusters == 1 | seurat_clusters == 2 | seurat_clusters == 3 ~ "MAIT",
  seurat_clusters == 4 ~ "Unknown",
  seurat_clusters == 5 ~ "MTC"
))
...
svm_annotation_ex_tc <- svm_annotation_ex_tc %>% mutate(cell_labels_smv_ex = case_when(
  seurat_clusters == 1   ~ "MAIT",
  seurat_clusters == 4 ~ "MTC"
))
...
save(t_tc,file="ut_tc_final.Rdata")
...
new_cluster_id_apc=c("DC", "M2Mp", "Mp", "M1Mp", "?", "M2Mp", "M2Mp", "?", "DC", "BC", "DC", "M2Mp", "Mp", "BC")
apc <- subseteR_part_2(t_apc, new_cluster_id_apc)

apc <- apc %>% mutate(cell_names = case_when(
  type == 0 | type == 8 | type == 10  ~ "DC",
  type == 2 | type == 12 ~ "Mp",
  type == 9 | type == 13 ~ "BC",
  type == 3 ~ "M1Mp",
  type == 1 | type == 5 | type == 6 | type == 11 ~ "M2Mp",
  type == 7 | type == 4 ~ "?"
...
t_apc_cell_metadata$tissue <- "uterus"
t_combined_cds_ep <- garnett_annotatoR_part1(t_apc, t_apc_cell_metadata, "ut_markers_apc")
t_apc <- garnett_annotatoR_part2(t_combined_cds_ep,t_combined_cds_ep, "ut_markers_apc", t_apc)
...
garnett_annotation_ex_apc <- garnett_annotation_ex_apc %>% mutate(cell_labels_garnett_ex = case_when(
  seurat_clusters == 0 | seurat_clusters == 12  ~ "Mp",
  seurat_clusters == 9 | seurat_clusters == 13 ~ "BC",
  seurat_clusters == 5 | seurat_clusters == 6 | seurat_clusters == 7 | seurat_clusters == 11  ~ "M2Mp",
  seurat_clusters == 2 | seurat_clusters ==  8  | seurat_clusters == 10 | seurat_clusters == 4~ "DC",
  seurat_clusters == 3 ~ "M1Mp",
  seurat_clusters == 1 ~ "Unknown" 
))
...
svm_annotation_ex_apc <- svm_annotation_ex_apc %>% mutate(cell_labels_smv_ex = case_when(
  seurat_clusters == 0  |  seurat_clusters == 4 ~ "DC",
  seurat_clusters == 1 |  seurat_clusters == 2 | seurat_clusters == 7  ~ "M2Mp"
))
...
save(t_apc,file="ut_apc_final.Rdata")
...
list[t_mac, mac_cluster, mac_subcluster] <- subseteR_part_1(t_combined, "MaC",1)
final_labels_mac <- data.frame("identity"="MaC", "cells"=names(t_mac$seurat_clusters))
rownames(final_labels_mac) <- final_labels_mac$cells

final_labels_level_2 <- rbind (final_labels_apc, final_labels_epc, final_labels_sc, final_labels_tc, final_labels_ec, final_labels_nkc, final_labels_mac)
...
t_combined_alt <- merge(`0002_mouse1_ut_filtered`, y = c(`0002_mouse10_ut_filtered`,`0002_mouse11_ut_filtered`,`0002_mouse12_ut_filtered`,
                                                         `0002_mouse13_ut_filtered`,`0002_mouse14_ut_filtered`,`0002_mouse15_ut_filtered`,
                                                         `0002_mouse16_ut_filtered`,`0002_mouse2_ut_filtered`,`0002_mouse3_ut_filtered`,
                                                         `0002_mouse6_ut_filtered`,`0002_mouse8_ut_filtered`,
                                                         `0002_mouse9_ut_filtered`), project = "mouse_ut", merge.data=TRUE)
...
write.table(epc_cluster,"epc_clusters",sep=",",quote=F,row.names = F)
