...
t_combined <- merge(`0002_mouse1_va_filtered`, y = c(`0002_mouse10_va_filtered`,`0002_mouse11_va_filtered`,`0002_mouse12_va_filtered`,
                                                     `0002_mouse13_va_filtered`,`0002_mouse14_va_filtered`,`0002_mouse15_va_filtered`,
                                                     `0002_mouse16_va_filtered`,`0002_mouse2_va_filtered`,`0002_mouse3_va_filtered`,
                                                     `0002_mouse8_va_filtered`, `0002_mouse7_va_filtered`, 
                                                     `0002_mouse9_va_filtered`), project = "mouse_va", merge.data=TRUE)
...
t_combined_cell_metadata <- t_combined_cell_metadata %>% mutate(condition = case_when(
  batch == "0002_mouse1_va" | batch == "0002_mouse12_va" | batch == "0002_mouse13_va" ~ "proestrus",
  batch == "0002_mouse2_va" | batch == "0002_mouse8_va" | batch == "0002_mouse16_va" | batch == "0002_mouse7_va" ~ "diestrus", 
  batch == "0002_mouse3_va" | batch == "0002_mouse9_va" | batch == "0002_mouse14_va" ~ "estrus",
  batch == "0002_mouse10_va" | batch == "0002_mouse11_va" | batch == "0002_mouse15_va" ~ "metestrus"))
...
markers <- list.load("vagina_markers.rdata")
...
new_cluster_id_t_com=c("APC", "APC", "EpC", "SC", "SC", "EpC", "EpC", "EpC", "EpC","EpC", "EpC", "EpC", "EpC", "EpC", "SC", "EpC", "EpC", "EpC", "APC", 
                       "EpC","EpC", "EpC", "EpC", "?","TC", "EpC", "SC","EpC", "EpC","EpC","EpC","EpC", "APC","EpC","SC","APC", "EpC","EpC","?", "EpC", "?", 
                       "EpC", "?", "SC","?")
...
t <- t %>% mutate(cell_names = case_when(
  type == 0 | type == 1 | type == 18 | type == 32 | type == 35  ~ "APC",
  type == 3 | type == 4 | type == 14 | type == 26 | type == 34 | type == 43 ~ "SC",
  type == 2 | type == 5 | type == 6 | type ==  7 | type == 8 | type == 9 | type == 10 | type ==  11 | type == 12 | type == 13
  | type == 15 | type == 16 | type == 17 | type == 19 | type == 20 | type == 21 | type == 22 | type == 25 | type == 27 | type == 28
  | type == 29 | type == 30 | type == 31 | type == 36 | type == 37 | type == 39 | type == 41  | type == 33 ~ "EpC",
  type == 23 | type == 38  | type == 40  | type == 42| type==44~ "?",
  type == 24  ~ "TC"
))
...
t_combined_cell_metadata$tissue <- "vagina"

t_combined_cds <- garnett_annotatoR_part1(t_combined, t_combined_cell_metadata, "vagina_markers_garnett")
t_combined <- garnett_annotatoR_part2(t_combined_cds, t_combined_cds, "vagina_markers_garnett", t_combined)
...
garnett_annotation_ex <- garnett_annotation_ex %>% mutate(cell_labels_garnett_ex = case_when(
  seurat_clusters == 0 | seurat_clusters == 1 | seurat_clusters == 18  | seurat_clusters == 35  ~ "APC",
  seurat_clusters == 3 | seurat_clusters == 4 | seurat_clusters == 14 | seurat_clusters == 26 | seurat_clusters == 34 | seurat_clusters == 43 ~ "SC",
  seurat_clusters == 38  | seurat_clusters == 40  | seurat_clusters == 2 | seurat_clusters == 5 | seurat_clusters == 6 | seurat_clusters ==  7 | seurat_clusters == 8 | seurat_clusters == 9 
  | seurat_clusters == 10 | seurat_clusters ==  11 | seurat_clusters == 12 | seurat_clusters == 13| seurat_clusters == 15 | seurat_clusters == 16 
  | seurat_clusters == 17 | seurat_clusters == 19 | seurat_clusters == 21 | seurat_clusters == 22 | seurat_clusters == 25 
  | seurat_clusters == 27 | seurat_clusters == 28 | seurat_clusters == 29  | seurat_clusters == 36 | seurat_clusters == 37 | seurat_clusters == 39
  | seurat_clusters == 41   | seurat_clusters == 23 | seurat_clusters==44  ~ "EpC",
  seurat_clusters == 42  | seurat_clusters == 20 | seurat_clusters == 30 
  | seurat_clusters == 31 | seurat_clusters == 32 | seurat_clusters == 33 ~ "Unknown",
  seurat_clusters == 24  ~ "TC"
))
...
save(t_combined,file="va_combined_new.Rdata")

list[t_non_match_ge, t_match_ge] <- svm_subseteR(t_combined)

pred.te_identity <- svm_returneR(t_match_ge, t_non_match_ge, 0.9, 0.2)
...
svm_annotation_ex <- svm_annotation_ex %>% mutate(cell_labels_smv_ex = case_when(
  seurat_clusters == 20  | seurat_clusters == 23 | seurat_clusters == 30 | seurat_clusters == 31 | seurat_clusters == 33 | seurat_clusters == 40 
  | seurat_clusters ==  44  ~ "EpC",
  seurat_clusters == 32 ~ "APC",
  seurat_clusters == 38  ~ "Er",
...
new_cluster_id_epc=c("?", "BEpC", "?", "BEpC", "BEpC", "IEpC", "BEpC", "IEpC","IEpC", "?", "BEpC", "IEpC", "BEpC",
                     "IEpC", "BEpC", "?", "?", "?", "IEpC", "BEpC", "SEpC", "BEpC", "BEpC", "SEpC", "?", "SEpC")
epc <- subseteR_part_2(t_epc, new_cluster_id_epc)

epc <- epc %>% mutate(cell_names = case_when(
  type == 20  | type == 25 ~ "SEpC",
  type == 1 | type == 3 | type == 4 | type ==6 | type==10  | type ==12 | type==14| type ==19 | type==21 | type ==22   ~ "BEpC",
  type == 5 | type == 7 | type == 8 | type == 11 | type == 13 | type == 18 | type == 23 ~ "IEpC",
  type== 0 | type == 2 | type == 9 | type == 15 | type == 16 | type ==17 | type==24 ~ "?"
...
t_epc_cell_metadata$tissue <- "vagina"
t_combined_cds_ep <- garnett_annotatoR_part1(t_epc, t_epc_cell_metadata, "va_markers_ep")
t_epc <- garnett_annotatoR_part2(t_combined_cds_ep,t_combined_cds_ep, "va_markers_ep", t_epc)
...
garnett_annotation_ex_epc <- garnett_annotation_ex_epc %>% mutate(cell_labels_garnett_ex = case_when(
  seurat_clusters == 1 | seurat_clusters == 4 | seurat_clusters == 8 | seurat_clusters == 14 | seurat_clusters == 15 | seurat_clusters == 17 
  | seurat_clusters == 19 | seurat_clusters == 21 ~ "BEpC",
  seurat_clusters == 7 | seurat_clusters == 13 | seurat_clusters == 18 | seurat_clusters == 20 ~ "IEpC",
  seurat_clusters ==  0 | seurat_clusters == 9 | seurat_clusters == 11 | seurat_clusters == 23  | seurat_clusters == 24 | seurat_clusters == 25  ~ "SEpC",
  seurat_clusters == 2 | seurat_clusters == 3 | seurat_clusters ==  10 | seurat_clusters == 5 | seurat_clusters == 6 | seurat_clusters == 12 |  
    seurat_clusters == 16 | seurat_clusters == 22   ~ "Unknown"
))
...
svm_annotation_ex_epc <- svm_annotation_ex_epc %>% mutate(cell_labels_smv_ex = case_when(
  seurat_clusters == 0 | seurat_clusters == 3 |  seurat_clusters == 5 | seurat_clusters == 10 | seurat_clusters == 11 | seurat_clusters == 15 
  | seurat_clusters == 16  | seurat_clusters == 23 ~ "BEpC",
  seurat_clusters == 2 | seurat_clusters == 6 | seurat_clusters == 8 | seurat_clusters == 9 | seurat_clusters == 12 | seurat_clusters == 17 
  | seurat_clusters == 24 | seurat_clusters == 20 ~ "IEpC",
  seurat_clusters == 22 ~ "EpC I"
))
...
save(t_epc,file="va_epc_final.Rdata")
...
new_cluster_id_sc=c("?", "F", "F","F", "F", "F", "F", "?","?","MC","?","?","?", "F", "?",  "F", "MC")
sc <- subseteR_part_2(t_sc, new_cluster_id_sc)

sc <- sc %>% mutate(cell_names = case_when(
  type ==  1 | type == 2  | type == 4 | type == 3 | type ==  5 | type ==  6 | type ==  13 | type ==  15~ "F",
  type == 9  | type == 16  ~ "MC",
  type == 0 | type == 7 | type == 10 | type == 12 | type ==  8 | type ==  11 | type ==  14~ "?"
))
...
t_sc_cell_metadata$tissue <- "vagina"
t_combined_cds_ep <- garnett_annotatoR_part1(t_sc, t_sc_cell_metadata, "va_markers_sc")
t_sc <- garnett_annotatoR_part2(t_combined_cds_ep,t_combined_cds_ep, "va_markers_sc", t_sc)
...
garnett_annotation_ex_sc <- garnett_annotation_ex_sc %>% mutate(cell_labels_garnett_ex = case_when(
  seurat_clusters ==  3 | seurat_clusters == 8 | seurat_clusters == 11 | seurat_clusters ==  13 | seurat_clusters == 15 ~ "F",
  seurat_clusters == 1 | seurat_clusters == 9   | seurat_clusters == 16~ "MC",
  seurat_clusters == 0 | seurat_clusters == 2 | seurat_clusters == 4  | seurat_clusters == 5  | seurat_clusters == 6  | seurat_clusters == 7
  | seurat_clusters == 10  | seurat_clusters == 12  | seurat_clusters == 14 ~ "Unknown"
...
svm_annotation_ex_sc <- svm_annotation_ex_sc %>% mutate(cell_labels_smv_ex = case_when(
  seurat_clusters == 1 | seurat_clusters == 2 | seurat_clusters == 4  | seurat_clusters == 5 | seurat_clusters == 6 | seurat_clusters == 7
  | seurat_clusters == 8  | seurat_clusters == 10  | seurat_clusters == 11  | seurat_clusters == 12  | seurat_clusters == 14~ "F",
  seurat_clusters == 0 ~ "SC I"
))
...
save(t_sc,file="va_sc_final.Rdata")
...
t_tc_cell_metadata$tissue <- "vagina"
t_combined_cds_ep <- garnett_annotatoR_part1(t_tc, t_tc_cell_metadata, "va_markers_tc")
t_tc <- garnett_annotatoR_part2(t_combined_cds_ep,t_combined_cds_ep, "va_markers_tc", t_tc)
...
garnett_annotation_ex_tc <- garnett_annotation_ex_tc %>% mutate(cell_labels_garnett_ex = case_when(
  seurat_clusters ==  0 | seurat_clusters == 4 | seurat_clusters == 5 ~ "MAIT",
  seurat_clusters == 3 | seurat_clusters == 2 ~ "iNKT",
  seurat_clusters == 1 | seurat_clusters == 7   ~ "Unknown",
  seurat_clusters == 6 ~ "MTC"
))
...
svm_annotation_ex_tc <- svm_annotation_ex_tc %>% mutate(cell_labels_smv_ex = case_when(
  seurat_clusters == 1  ~ "iNKT",
  seurat_clusters == 7 ~ "MAIT"
))
...
save(t_tc,file="va_tc_final.Rdata")
...
new_cluster_id_apc=c("M1Mp", "M1Mp", "M1Mp", "M1Mp","M1Mp", "M1Mp",  "?", "?", "DC", "DC", "DC", "?","DC","?")
apc <- subseteR_part_2(t_apc, new_cluster_id_apc)

apc <- apc %>% mutate(cell_names = case_when(
  type == 8 | type == 9 | type == 12 | type== 10 ~ "DC",
  type == 1 | type == 2  | type == 3 | type == 4 | type==0 | type== 5 ~ "M1Mp",
  type == 6 | type == 7 | type ==13 | type ==11 ~ "?"
...
t_apc_cell_metadata$tissue <- "vagina"
t_combined_cds_ep <- garnett_annotatoR_part1(t_apc, t_apc_cell_metadata, "va_markers_apc")
t_apc <- garnett_annotatoR_part2(t_combined_cds_ep,t_combined_cds_ep, "va_markers_apc", t_apc)
...
garnett_annotation_ex_apc <- garnett_annotation_ex_apc %>% mutate(cell_labels_garnett_ex = case_when(
  seurat_clusters == 3 | seurat_clusters == 4 | seurat_clusters == 6 | seurat_clusters == 11 ~ "M1Mp",
  seurat_clusters == 0 | seurat_clusters == 1 | seurat_clusters == 2 | seurat_clusters == 5 ~ "Mp",
  seurat_clusters == 8 | seurat_clusters == 9 | seurat_clusters == 10 | seurat_clusters == 12 | seurat_clusters == 13  ~ "DC",
  seurat_clusters == 7~ "Unknown" 
))
...
svm_annotation_ex_apc <- svm_annotation_ex_apc %>% mutate(cell_labels_smv_ex = case_when(
  seurat_clusters == 1 | seurat_clusters == 0 | seurat_clusters == 2 | seurat_clusters == 5 | seurat_clusters == 6 | seurat_clusters == 7| seurat_clusters == 11 ~ "M1Mp",
  seurat_clusters == 13 ~ "DC"
...
#######################
Idents(t_combined) <- t_combined$final_labels
list[t_ec, ec_cluster, ec_subcluster] <- subseteR_part_1(t_combined, "EC",1)
...
final_labels_level_2 <- rbind (final_labels_apc, final_labels_epc, final_labels_sc, final_labels_tc, final_labels_ec, final_labels_er)
...
lotR_alt("/matrix/vagina")

t_combined_alt <- merge(`0002_mouse1_va_filtered`, y = c(`0002_mouse10_va_filtered`,`0002_mouse11_va_filtered`,`0002_mouse12_va_filtered`,
                                                         `0002_mouse13_va_filtered`,`0002_mouse14_va_filtered`,`0002_mouse15_va_filtered`,
                                                         `0002_mouse16_va_filtered`,`0002_mouse2_va_filtered`,`0002_mouse3_va_filtered`,
                                                         `0002_mouse8_va_filtered`, `0002_mouse7_va_filtered`, 
                                                         `0002_mouse9_va_filtered`), project = "mouse_va", merge.data=TRUE)
...
write.table(t_combined_identity,"va_combined_identity",sep=",",quote=F,row.names = F)
